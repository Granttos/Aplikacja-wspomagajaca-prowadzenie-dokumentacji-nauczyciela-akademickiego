        ...
        <div class="card">
            <div class="card-body login-card-body">
                ...
                <div class="login-logo">
                    <h2 class="logo-text">eNoteBook</h2>
                </div>
                ...
                <form action="index.php" method="post" id="form2">
                    ...
                    <div class="input-group mb-3">
                        <input type="password" class="form-control" placeholder="Hasło" name="password" id="password1">
                        <div class="input-group-append">
                            <div class="input-group-text">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <button type="submit" class="btn btn-primary btn-block signin-btn" id="btnSubmit1">Zaloguj</button>
                        </div>
                        <!-- /.col -->
                    </div>
                </form>
                ...
                ?>
                    <p class="mb-0 pCreatAdmin">
                        <center><a href="#modalSignup" data-toggle="modal" class="text-center">Stwórz konto admina</a></center>
                    </p>
        ...
        <div class="modal-dialog " role="document">
            <div class="modal-content">
                <div class="modal-header bg-primary">
                    <h5 class="modal-title">Stwórz konto admina</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10" id="divAddress">
                                <input type="text" class="form-control" placeholder="Enter address" id="addressres" name="addressres">
	...
	if (isset($_GET["do"]) && ($_GET["do"] == "login_error")) {
		...
		if ($msg == 1) {
			...
			$(function() {
				...
				toastr["error"]("Login lub hasło nieprawidłowe ,spróbuj jeszcze raz!!");
