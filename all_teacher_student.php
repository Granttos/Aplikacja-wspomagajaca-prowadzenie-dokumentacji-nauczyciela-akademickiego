            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="m-0 text-dark">Wszyscy nauczyciele</h1>
                            </div><!-- /.col -->
                            <div class="col-sm-6">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="#teacherDetails" data-toggle="modal" onClick="teacherDetails(this);" class="btn btn-success btn-xs " data-id="<?php echo $row['id']; ?>">Zobacz profil</a>
                                                            </td>
                                                        </tr>
                                                <?php }
                                                } ?>
