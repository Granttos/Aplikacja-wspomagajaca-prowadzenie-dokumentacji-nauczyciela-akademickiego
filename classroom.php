            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="m-0 text-dark">Grupy zajęciowe</h1>
                            </div><!-- /.col -->
                            <div class="col-sm-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="card card-outline card-primary">
                                    <div class="card-header">
                                        <h3 class="card-title">Dodaj grupę zajęciową</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <!-- form start -->
                                    <form role="form" action="index.php" method="POST" autocomplete="off">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group" id="divStudentCount">
                                                <label for="student_count">Max liczba uczestników</label>
                                                <input type="text" class="form-control" placeholder="Podaj liczbę" name="student_count" id="student_count">
                                            </div>
                                        </div>
                                        <!-- /.card-body -->
                    ...
                    <div class="container-fluid">
                        <div class="row" id="table1">
                            <div class="col-8">
                                <div class="card card-outline card-primary">
                                    <div class="card-header">
                                        <h3 class="card-title">Grupy zajęciowe</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <div class="card-body">
                    ...
                    <div class="modal-dialog " role="document">
                        <div class="modal-content">
                            <div class="modal-header bg-primary">
                                <h5 class="modal-title">Edytuj grupę zajęciową</h5>
                            ...
                            <div class="modal-body">
                                <div class="form-group" id="divNameUpdate">
                                    ...
                                    <input type="text" class="form-control" placeholder="Podaj nową nazwę" id="name1">
                                </div>
                                <div class="form-group" id="divSCountUpdate">
                                    <label for="student_count1">Max liczba uczestników</label>
                                    <input type="text" class="form-control" placeholder="Podaj nową liczbę" id="student_count1">
                                </div>
                            </div>
        ...
        if (isset($_GET["do"]) && ($_GET["do"] == "alert_from_insert")) {
            ...
            if ($msg == 1) {
                ...
                $(function() {
                    ...
                    toastr["warning"]("Ta grupa już istnieje!");
