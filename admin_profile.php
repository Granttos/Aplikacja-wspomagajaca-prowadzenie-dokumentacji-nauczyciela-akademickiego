                                    ...
                                    <div class="card-body">
                                        <table class="table table-bordered table-striped">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td style="width: 30%">Nazwa użytkownika</td>
                                                    <td><?php echo $row['email']; ?></td>
                                                </tr>
                                                <tr>
                                                    <td>Hasło</td>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8" >
                                        <input type="password" class="form-control " placeholder="Podaj aktualne hasło" id="current_password" >
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="password" class="form-control " placeholder="Podaj nowe hasło" id="new_password" >
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="password" class="form-control " placeholder="Podaj hasło" id="confirm_password" >
                                    </div>
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn bg-primary" id="btnUpdate" style="width:100%;" onClick="updatePassword();">Aktualizuj</button>
                            </div>
                        </div>
                    </div>
                </div>
