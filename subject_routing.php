            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="m-0 text-dark">Zarządzanie ocenami</h1>
                            </div><!-- /.col -->
                            <div class="col-sm-6">
                            ...
                            <div class="col-10">
                                <div class="card card-outline card-primary">
                                    <div class="card-header">
                                        ...
                                        <h3 class="card-title">Zarządzanie ocenami</h3>
                                        <a href="#modalInsertForm" class="btn btn-success btn-sm float-right" data-toggle="modal">Dodaj <i class="fas fa-plus"></i></a>
                                    ...
                                    <div class="card-body">
                                        <table id="dTable" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                $sql = "SELECT subject_routing.id as sr_id, grade.name as g_name, subject.name as s_name, teacher.name as t_name 
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="#modalUpdateForm" onClick="updateRecord(this);" class="btn btn-primary btn-xs " data-id="<?php echo $row['sr_id']; ?>" data-toggle="modal">Edytuj</a>
                                                                <a href="#" onClick="deleteRecord(this);" class="btn btn-danger btn-xs " data-id="<?php echo $row['sr_id']; ?>" data-toggle="modal">Usuń</a>
                                                            </td>
                                                        </tr>
                                                <?php }
