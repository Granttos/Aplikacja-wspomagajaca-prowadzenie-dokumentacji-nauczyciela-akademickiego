            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="m-0 text-dark">Mój nauczyciel</h1>
                            </div><!-- /.col -->
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                                    <li class="breadcrumb-item active">Nauczyciel</li>
                                    <li class="breadcrumb-item active">Mój nauczyciel</li>
                                </ol>
                            </div><!-- /.col -->
                        </div><!-- /.row -->
                    </div><!-- /.container-fluid -->
                            ...
                            <div class="col-6">
                                <div class="card card-outline card-primary">
                                    <div class="card-header">
                                        <h3 class="card-title">Mój nauczyciel</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <div class="card-body">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="#teacherDetails" data-toggle="modal" onClick="teacherDetails(this);" class="btn btn-success btn-xs " data-id="<?php echo $row['t_id']; ?>">Wyświetl profil</a>
                                                            </td>
                                                        </tr>
                                                <?php }
                                                } ?>
