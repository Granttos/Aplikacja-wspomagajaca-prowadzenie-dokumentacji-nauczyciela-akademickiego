            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="m-0 text-dark">Nauczyciel</h1>
                            </div><!-- /.col -->
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                                    <li class="breadcrumb-item active">Nauczyciel</li>
                                    <li class="breadcrumb-item active">Dodaj nauczyciela</li>
                                </ol>
                            </div><!-- /.col -->
                        </div><!-- /.row -->
                    </div><!-- /.container-fluid -->
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="card card-outline card-primary">
                                    <div class="card-header">
                                        <h3 class="card-title">Dodaj nauczyciela</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <!-- form start -->
                                    <form action="index.php" method="POST" enctype="multipart/form-data" autocomplete="off">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group row" >
                                                <label for="name" class="col-sm-2 col-form-label">Imie/Nazwisko</label>
                                            ...
                                            <div class="form-group row" >
                                                <label for="gender" class="col-sm-2 col-form-label">Płeć</label>
                                            ...
                                            <div class="form-group row" >
                                                ...
                                                <div class="col-sm-7" id="divPhone">
                                                    <input type="text" class="form-control " placeholder="Podaj nr telefonu" id="phone" name="phone">
                                                </div>
                                            </div>
                                            <div class="form-group row" >
