            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="m-0 text-dark">Studenci</h1>
                            </div><!-- /.col -->
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                                    <li class="breadcrumb-item active">Studenci</li>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="card card-outline card-primary">
                                    <div class="card-header">
                                        <h3 class="card-title">Wybierz ocenę</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <!-- form start -->
                                    ...
                                    <div class="card-body">
                                        <div class="form-group row">
                                            <label for="grade_id" class="col-sm-2 col-form-label">Ocena</label>
                                    ...
                                    <div class="card-footer">
                                        <button type="button" class="btn btn-primary" id="btnSubmit" onclick="showStudentTable();">Wyszukaj</button>
                                    </div>
